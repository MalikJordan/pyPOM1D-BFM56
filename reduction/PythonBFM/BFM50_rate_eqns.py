...
def bfm50_rate_eqns(time, conc, seasonal_cycle=True):
    ...
    if seasonal_cycle:
        ...
        qs_win = 20.0                                   # Winter irradiance value
        qs_sum = 300.0                                  # Summer irradiance value
    ...
    # Bacterioplankton
    db1c_dt = dBcdt_upt_r1c + dBcdt_upt_r6c - dBcdt_rsp_o3c - dBcdt_lys_r1c - dBcdt_lys_r6c - (dZ5cdt_prd["b1"] + dZ6cdt_prd["b1"]) - dBcdt_rel_r2c - dBcdt_rel_r3c

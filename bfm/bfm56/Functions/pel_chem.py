...
def pel_chem_eqns(bfm_phys_vars, pel_chem_parameters, environmental_parameters, constant_parameters, del_z, temper, d3state, flPTn6r):
    ...
    # ruQ6c = bfm_phys_vars.detritus_sedimentation[num_boxes-1]*r6c[num_boxes-1]*np.ones(num_boxes)
    # ruQ6n = bfm_phys_vars.detritus_sedimentation[num_boxes-1]*r6n[num_boxes-1]*np.ones(num_boxes)
    # ruQ6p = bfm_phys_vars.detritus_sedimentation[num_boxes-1]*r6p[num_boxes-1]*np.ones(num_boxes)
    # ruQ6s = bfm_phys_vars.detritus_sedimentation[num_boxes-1]*r6s[num_boxes-1]*np.ones(num_boxes)

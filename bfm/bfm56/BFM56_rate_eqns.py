...
from bfm.bfm56.Functions.seasonal_cycling_functions import get_wind, get_salinity, get_sunlight, get_temperature, calculate_density
from bfm.bfm56.Functions.phyto import phyto_eqns, calc_chla
from bfm.bfm56.Functions.bacteria import bacteria_eqns
from bfm.bfm56.Functions.predation import get_mesozoo_predation_terms, get_microzoo_predation_terms
from bfm.bfm56.Functions.micro import microzoo_eqns
from bfm.bfm56.Functions.meso import mesozoo_eqns
from bfm.bfm56.Functions.pel_chem import pel_chem_eqns
from bfm.bfm56.Functions.oxygen import calculate_oxygen_reaeration
from bfm.bfm56.Functions.co2_flux_functions import calculate_co2_flux
from bfm.bfm56.Functions.other_functions import insw_vector, get_concentration_ratio
...
def bfm56_rate_eqns(iter, bfm_phys_vars, time, d3state, seasonal_cycle=False):
    ...
    #--------------------------------------------------------------------------
    chlorophylla = calc_chla(d3state)
    ...
    (dp1cdt_gpp_o3c, dp1cdt_rsp_o3c, dp1cdt_lys_r1c, dp1cdt_lys_r6c, dp1cdt_exu_r2c, dp1ndt_upt_n3n, dp1ndt_upt_n4n, 
     ...
     dp1ldt_syn, dp1sdt_upt_n5s, dp1sdt_lys_r6s, bfm_phys_vars) = phyto_eqns(d3state, bfm_phys_vars, phyto1_prameters, environmental_parameters, constant_parameters, del_z, 1, irradiance, p1c, p1n, p1p, p1l, suspended_sediments, temper, time, xEPS)
    ...
    (dp2cdt_gpp_o3c, dp2cdt_rsp_o3c, dp2cdt_lys_r1c, dp2cdt_lys_r6c, dp2cdt_exu_r2c, dp2ndt_upt_n3n, dp2ndt_upt_n4n, 
     ...
     dp2ldt_syn, dP2sdt_upt_n5s, dP2sdt_lys_r6s, bfm_phys_vars) = phyto_eqns(d3state, bfm_phys_vars, phyto2_prameters, environmental_parameters, constant_parameters, del_z, 2, irradiance, p2c, p2n, p2p, p2l, suspended_sediments, temper, time, xEPS)
    ...
    (dp3cdt_gpp_o3c, dp3cdt_rsp_o3c, dp3cdt_lys_r1c, dp3cdt_lys_r6c, dp3cdt_exu_r2c, dp3ndt_upt_n3n, dp3ndt_upt_n4n, 
     ...
     dp3ldt_syn, dP3sdt_upt_n5s, dP3sdt_lys_r6s, bfm_phys_vars) = phyto_eqns(d3state, bfm_phys_vars, phyto3_prameters, environmental_parameters, constant_parameters, del_z, 3, irradiance, p3c, p3n, p3p, p3l, suspended_sediments, temper, time, xEPS)
    ...
    (dp4cdt_gpp_o3c, dp4cdt_rsp_o3c, dp4cdt_lys_r1c, dp4cdt_lys_r6c, dp4cdt_exu_r2c, dp4ndt_upt_n3n, dp4ndt_upt_n4n, 
     ...
     dp4ldt_syn, dP4sdt_upt_n5s, dP4sdt_lys_r6s, bfm_phys_vars) = phyto_eqns(d3state, bfm_phys_vars, phyto4_prameters, environmental_parameters, constant_parameters, del_z, 4, irradiance, p4c, p4n, p4p, p4l, suspended_sediments, temper, time, xEPS)
   ...
   # Z5: Microzooplankton terms
    ...
    # Net Primary Production (npp = 'ruPTc' - 'resPP' - 'resZT' = Gross Primary Production - Respiration of Phytoplankton - Respiration of Zooplankton)
    # net_primary_production = (dp1cdt_gpp_o3c + dp2cdt_gpp_o3c + dp3cdt_gpp_o3c + dp4cdt_gpp_o3c) - (dp1cdt_rsp_o3c + dp2cdt_rsp_o3c + dp3cdt_rsp_o3c + dp4cdt_rsp_o3c) - (dz3cdt_rsp_o3c + dz4cdt_rsp_o3c + dz5cdt_rsp_o3c + dz6cdt_rsp_o3c) + dBcdt_rsp_o3c # closest so far
    # net_primary_production = -(dp1cdt_gpp_o3c + dp2cdt_gpp_o3c + dp3cdt_gpp_o3c + dp4cdt_gpp_o3c) + (dp1cdt_rsp_o3c + dp2cdt_rsp_o3c + dp3cdt_rsp_o3c + dp4cdt_rsp_o3c) + (dz3cdt_rsp_o3c + dz4cdt_rsp_o3c + dz5cdt_rsp_o3c + dz6cdt_rsp_o3c) + dBcdt_rsp_o3c + (dr6cdt_remin_o3c + dr1cdt_remin_o3c)
    
    net_primary_production = ((dp1cdt_gpp_o3c + dp2cdt_gpp_o3c + dp3cdt_gpp_o3c + dp4cdt_gpp_o3c) - (dp1cdt_rsp_o3c + dp2cdt_rsp_o3c + dp3cdt_rsp_o3c + dp4cdt_rsp_o3c) - (dz3cdt_rsp_o3c + dz4cdt_rsp_o3c + dz5cdt_rsp_o3c + dz6cdt_rsp_o3c))/12

    # net_primary_production = -((dp1cdt_gpp_o3c + dp2cdt_gpp_o3c + dp3cdt_gpp_o3c + dp4cdt_gpp_o3c) - (dp1cdt_rsp_o3c + dp2cdt_rsp_o3c + dp3cdt_rsp_o3c + dp4cdt_rsp_o3c) - (dz3cdt_rsp_o3c + dz4cdt_rsp_o3c + dz5cdt_rsp_o3c + dz6cdt_rsp_o3c) - dBcdt_rsp_o3c)
    # net_primary_production = (-dp1cdt_gpp_o3c + dp1cdt_rsp_o3c) + (-dp2cdt_gpp_o3c + dp2cdt_rsp_o3c) + (-dp3cdt_gpp_o3c + dp3cdt_rsp_o3c) + (-dp4cdt_gpp_o3c + dp4cdt_rsp_o3c) + dBcdt_rsp_o3c + dz3cdt_rsp_o3c + dz4cdt_rsp_o3c + dz5cdt_rsp_o3c + dz6cdt_rsp_o3c + (dr6cdt_remin_o3c + dr1cdt_remin_o3c)
    # net_primary_production = dp2cdt_gpp_o3c - dp2cdt_rsp_o3c - dz5cdt_rsp_o3c
    # net_primary_production = (-dp1cdt_gpp_o3c + dp1cdt_rsp_o3c) + (-dp2cdt_gpp_o3c + dp2cdt_rsp_o3c) + (-dp3cdt_gpp_o3c + dp3cdt_rsp_o3c) + (-dp4cdt_gpp_o3c + dp4cdt_rsp_o3c)
    # Net Primary Production (npp = phyto_gpp_o3c - phyto_rsp_o3c - phyto_exu_r2c - phyto_lys_r1c - phyto_lys_r6c)
    # net_primary_production = (dp1cdt_gpp_o3c + dp2cdt_gpp_o3c + dp3cdt_gpp_o3c + dp4cdt_gpp_o3c) - (dp1cdt_rsp_o3c + dp2cdt_rsp_o3c + dp3cdt_rsp_o3c + dp4cdt_rsp_o3c) - (dp1cdt_exu_r2c + dp2cdt_exu_r2c + dp3cdt_exu_r2c + dp4cdt_exu_r2c) - (dp1cdt_lys_r1c + dp2cdt_lys_r1c + dp3cdt_lys_r1c + dp4cdt_lys_r1c) - (dp1cdt_lys_r6c + dp2cdt_lys_r6c + dp3cdt_lys_r6c + dp4cdt_lys_r6c)
    
    # for i in range(0, num_boxes):
    #     # npp[i] = max(0,npp[i])
    #     net_primary_production[i] = max(0,net_primary_production[i])
    # if (iter+1)%1000 == 0:
    #     x=1
    ...
    return rates, bfm_phys_vars, dOdt_wind, do3cdt_air_sea_flux, chlorophylla, net_primary_production
...
if __name__ == '__main__':
    ...
    # Integrate
    solution_full_model = solve_ivp(bfm56_rate_eqns, t_span, c0, method='RK23')
